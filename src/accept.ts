...
import { Accept, PROCESSING_FEE } from "./contracts/auction"
import { client } from "./client"
import { readMnemonic } from "./read-mnemonic"

async function accept(owner: Address, keys: KeyPair, auction: Address) {
...
async function run() {
    ...
    await accept(owner, ownerKeys, auction)
}
